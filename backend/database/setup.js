...
function inicializarTabelas() {
  ...
  migrar(`ALTER TABLE candidaturas_desafio ADD COLUMN score_ia INTEGER`);
  migrar(`ALTER TABLE candidaturas_desafio ADD COLUMN relatorio_ia TEXT`);
  migrar(`ALTER TABLE pagamentos ADD COLUMN pagarme_order_id TEXT`);
  migrar(`ALTER TABLE pagamentos ADD COLUMN checkout_url TEXT`);
